...
def fetch_ccl_biometric_data(
    ...
    if not employee_code:
        ...
        ccl_subsidiary_ids = list(

            SubsidiaryMaster.objects.filter(

                id__in=user_to_subsidiary.values(),
                subsidiary_code__iexact="CCL"
        ...
        for schedule in active_schedules:
            ...
            subsidiary_id = user_to_subsidiary.get(
                creator_id
            )

            if subsidiary_id in ccl_subsidiary_ids:

                ccl_schedules.append(
                    schedule
                )
    ...
    url = "http://202.191.129.12:9001/TimeWatchAPI/CCLAttendance"
...
def sync_ccl_biometric_attendance(request):
    ...
    try:
        ...
        return JsonResponse({
            ...
            "status": "success",
            "message": "CCL biometric attendance synced successfully"
